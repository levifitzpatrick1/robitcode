...
public class Constants {
  ...
  private static final Alert invalidRobotAlert = new Alert("Invalid Robot",
      "The robot type is invalid. Please check the robot type in Constants.java", AlertType.ERROR);
  ...
  public static class VisionConstants {
    ...
    public static final double poseCheckerDistance = 0.5;

    public static final String fieldLayoutPath = "";
  }

  // Robot Type Info
  public static final Map<RobotType, String> logFolders = Map.of(RobotType.ROBOT_PHYSICAL, "/media/sda2");
