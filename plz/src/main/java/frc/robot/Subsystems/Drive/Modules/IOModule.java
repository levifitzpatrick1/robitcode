 ...
 *
 * <p>
 * This interface outlines the essential methods for controlling
 * and obtaining data from a swerve module's drive and turn motors.
 * </p>
 *
 * <p>
 * Derived classes such as <code>IOModuleSim</code> and
 * <code>IOModuleSparkMax</code>
 * provide specific implementations for simulation and SparkMax-based swerve
 * modules,
 * respectively.
 * </p>
 */
